...
#include "../common/RaiboPositionController.hpp"
...
//    std::string network_path = current_path + "/../../../s/rsg_raibo_rough_terrain/default_controller_demo/module/controller/raibot_default_controller/network/network_100000";
    std::string network_path = current_path + "/../../../../default_controller_demo/module/controller/raibot_position_controller_sim/network/network_100000";
    actor_.readParamFromTxt(network_path + "/full_20000.txt");
...
//    std::cout << "Fuck" << std::endl;
    ...
    std::string in_line;
    std::ifstream obsMean_file(network_path + "/mean20000.csv");
    std::ifstream obsVariance_file(network_path + "/var20000.csv");
