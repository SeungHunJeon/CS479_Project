...
//
//    auto raibo_0 = world_0.addArticulatedSystem(resourceDir + "/raibot/urdf/raibot_simplified.urdf");
...
//      world_batch_[i]->getObject("object")->setAngularDamping({1.5*friction/1.1, 2.0*friction/1.1, 2.0*friction/1.1});
//      world_batch_[i]->getObject("object")->setLinearDampling(0.6*friction/1.1);
//    }
//  }
//
//  void hard_reset () {
...
//      auto Obj = objectGenerator_.generateObject(world_batch_[i]);
//    }
//  }
//
